...
public class UserServiceImpl implements UserService {
    ...
    public Page<User> getPaged(PagingRequest request) {
        Specification<User> spec = (root, query, cb) -> {
            ...
            if (request.getRole() != null && !request.getRole().trim().isEmpty() && !"ALL".equalsIgnoreCase(request.getRole())) {
                try {
                    com.family.common.enums.RoleEnum roleEnum = com.family.common.enums.RoleEnum.valueOf(request.getRole());
